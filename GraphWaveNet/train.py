...
parser.add_argument('--data',type=str,default='EMPACTLABS/data/ours_doc_one_week',help='data path')
...
parser.add_argument('--in_dim',type=int,default=4,help='inputs dimension , 피쳐 개수로 설정')
...
parser.add_arguement('--gat', action='store_true', help='use GAT')
...
def main():
    ...
    dataloader = util.load_and_preprocess_dataset(args.data, args.batch_size, args.target_feature_index ,apply_preprocessing=False)
    ...
    for i in range(1,args.epochs+1):
        ...
        for iter, (x, y) in enumerate(dataloader['train_loader'].get_iterator()):
            ...
            metrics = engine.train(trainx, trainy[:,args.target_feature_index,:,:]) # 0:occupancy, 1:demand, 2:has_fast_charger, 3:has_slow_charger
        ...
        if mvalid_loss < best_valid_loss:
            ...
            best_model_path = args.save + "_best.pth"
    ...
    pickle.dump(pred_full.cpu().numpy(), open('pred_gwn.pkl', 'wb'))
